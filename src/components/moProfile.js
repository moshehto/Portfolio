...
1. **Remote Software Engineering Intern — Thing Logix**  
...
2. **Founding Engineer — Daawa (Wedding RSVP System)**  
   - Location: Riyadh, KSA  
...
2. **GPT-Powered Portfolio Chatbot**  
   ...
   - Created an AI chatbot embedded in Mo’s portfolio. Answers questions about Mo with a friendly tone and structured multi-turn support.  
   - Features a modern UI, Gemini prompt injection, and interactive frontend.

---

🧪 Extra (Mention only if asked directly)
